...
<div class="card-body">
     @if ($errors->any())
            ...
            @endif
<form class="forms-sample" method="POST" action="{{url('Add-Menu')}}" enctype="multipart/form-data"> 
  {{ csrf_field() }}
<div class="row">
...
<input  type="text" id="menu" name="menu" placeholder="Add Category" 
    autocomplete="off" required="require">
</div>
</div>
...
<label>Category Code</label>
 <input  type="text" id="catgry" name="catgry" placeholder="Add Category Code" 
    autocomplete="off" required="require">
</div>
</div>

...
<div class="app-container app-theme-white body-tabs-shadow  fixed-header">
  ...
  <!-----------------------------left_menu---------------------> 
         ...
         <div class="app-main__outer">
          ...
          <h4 class="text-center">Add Third Menu</h4>



  <form class="forms-sample" method="POST" action="{{url('Add-lstMenu')}}" enctype="multipart/form-data"> 
  {{ csrf_field() }}
   @if ($errors->any())
  ...
  <div class="Services">
    <label for="name" class="form-label">Third Menu:</label>
    <input  type="text" id="menu" name="menu" placeholder="Add Third Menu" 
 ...
 <div class="two-btn" style="margin-top: 2%;">
        ...
        <?php
            ...
            $Lastmenus = DB::table('last_menu')->get();
            ?>
    ...
    data-target='#cat_model' data-id="{{ $Lastmenu->id }}" 
    class="btn btn-primary">Edit</a>
            </td>
            <td>
    <form action="{{ route('Lastmenu.delete', ['lid' => $Lastmenu->id]) }}" method="POST">
                    ...
                    @csrf
                    @method('DELETE')
                    <input type="text" name="cityId" hidden value="{{ $Lastmenu->id }}">
...
<label style="margin-left: 20%;">Third Menu : </label>
...
$('body').on('click', '#editcatgry', function (event) {
    ...
    var id = $(this).data('id');
    console.log(id)
    $.get('lmenu/' + id + '/edit', function (data) {

...
<h4>Product Add Third Category</h4>
<h6>Create new product third Category</h6>
</div>
</div>
...
<form class="forms-sample" method="POST" action="{{url('Add-Thrmenu')}}" enctype="multipart/form-data"> 
  {{ csrf_field() }}
<div class="row">
...
<input  type="text" id="thcategory" name="thcategory" autocomplete="off" required="require">
</div>
</div>

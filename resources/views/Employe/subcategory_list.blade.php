...
<div class="page-btn">
<a href="{{ url('/addsubcategory') }}" class="btn btn-added">
<img src="img/icons/plus.svg" class="me-1" alt="img">Add Subcategory
</a>
</div>
</div>
 @if ($errors->any())
...
<td>
    <form class="forms-sample" method="POST" action="{{url('deletedsubcat')}}" enctype="multipart/form-data">
                  @csrf
                  @method('post')
